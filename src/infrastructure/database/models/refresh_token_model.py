...
class RefreshTokenModel(Base):
    ...
    replaced_by_token_id = Column(PG_UUID(as_uuid=True), ForeignKey("refresh_tokens.id", ondelete="SET NULL"), nullable=True)
    ...
    replaced_by = relationship("RefreshTokenModel", remote_side=[id], foreign_keys=[replaced_by_token_id])
