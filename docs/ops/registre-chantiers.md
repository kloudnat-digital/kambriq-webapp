...
**Pending:** the same read after the deploy - `bigint`, 238, sum 97 250 000.

### Signed-in price smoke - `EN COURS`
...
**Pending:** the first develop run of the delivery journeys with both checks
green.
