...
| `confirmRemainingPayment`     | `EN COURS`          | G20, decided by Visquis on 26 September and built: every payment states its purpose (`ACOMPTE`, `SOLDE`), one live payment per reservation and purpose, each money step asks the ledger for its own purpose, and the balance is the total minus what the deposit RECEIVED. Pending: the migration read back on dev                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
