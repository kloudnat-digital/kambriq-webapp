...
| Audit 2026-09-23, wave 1  | `EN COURS`          | four security fixes on `fix/wave1-security`, unmerged. **The fifth finding is open**: the API bearer token ships to every browser in the RSC payload                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
